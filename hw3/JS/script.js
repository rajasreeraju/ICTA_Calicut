function generate(){
    var name=document.getElementById("getname").text;
    console.log(name);
    var regno=document.getElementById("getroll").value;
    var op=document.getElementById("getsem");
    var semester=op.options[op.selectedIndex].value;
    var college=document.getElementById("cname").value;
